...
int main(int argc, char *argv[]) {
    ...
    @autoreleasepool {
        ...
        // Set the PYTHONPATH
        python_path = [NSString stringWithFormat:@"PYTHONPATH=%@/Library/Application Support/com.tencent.python/app:%@/Library/Application Support/com.tencent.python/app_packages", resourcePath, resourcePath, nil];
        ...
        main_script = [
            [[NSBundle mainBundle] pathForResource:@"Library/Application Support/com.tencent.python/app/main"
